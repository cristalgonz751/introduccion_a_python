...
def cifrar_en_consola():
  ...
  return mensaje_cifrado, tipo  ### el print no va a molestar en este caso?
...
def guardar_mensaje(destinatario, cifrado, mensaje_cifrado):
  ...
  while True:
    ...
    if opcion == "4":
      ...
      if verificar_destinatario(destinatario):
        ...
        mensaje_cifrado, tipo = cifrar_en_consola()
      else:
